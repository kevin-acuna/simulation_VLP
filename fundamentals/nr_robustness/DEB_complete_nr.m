function DEB = DEB_complete_nr(R, nt_orientations, T, Pt, m, A_det, theta_half, Psi_FOV, sigma2, N, nr)
% DEB_complete_nr - Direction Error Bound with configurable receiver orientation
%
% Identical to DEB_complete except nr is an EXPLICIT input parameter
% instead of being hardcoded to [0;0;1]. This allows evaluating the DEB
% under different receiver tilts.
%
% INPUTS:
%   R, nt_orientations, T, Pt, m, A_det, theta_half, Psi_FOV, sigma2, N
%     — same as DEB_complete (see that function for documentation)
%   nr : 3×1 receiver normal vector (unit vector pointing outward from PD)
%
% OUTPUT:
