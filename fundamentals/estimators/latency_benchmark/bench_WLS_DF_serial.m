%% Latency Benchmark — WLS: Direction-Finding + 3D Positioning (SERIAL)
% Identical logic to bench_WLS_DF.m but WITHOUT parfor.
...
fprintf('\n========================================\n');
fprintf(' WLS LATENCY BENCHMARK (K=%d) — SERIAL\n', N_or);
fprintf('========================================\n');
...
save_path = fullfile(results_dir, sprintf('bench_WLS_K%d_serial.mat', N_or));
