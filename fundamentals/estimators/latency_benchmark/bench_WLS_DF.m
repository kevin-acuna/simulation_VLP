%% Latency Benchmark — WLS: Direction-Finding + 3D Positioning
% Measures vlp_wls() in isolation for DF, then the full 3D pipeline.
...
fprintf('bench_WLS_DF — using %d workers\n\n', pool.NumWorkers);
...
fprintf('\n========================================\n');
fprintf(' WLS LATENCY BENCHMARK (K=%d)\n', N_or);
fprintf('========================================\n');
...
save_path = fullfile(results_dir, sprintf('bench_WLS_K%d.mat', N_or));
