%% Latency Benchmark — NL-MLE: Direction-Finding + 3D Positioning
% Measures the full NL-MLE pipeline in isolation (including mean preprocessing).
...
fprintf('bench_NL_DF — using %d workers\n\n', pool.NumWorkers);
...
fprintf('\n========================================\n');
fprintf(' NL-MLE LATENCY BENCHMARK (K=%d)\n', N_or);
fprintf('========================================\n');
...
save_path = fullfile(results_dir, sprintf('bench_NL_K%d.mat', N_or));
