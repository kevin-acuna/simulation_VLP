%% Latency Benchmark — GLS: Direction-Finding + 3D Positioning (SERIAL)
% Identical logic to bench_GLS_DF.m but WITHOUT parfor.
...
% HYPERPARAMETERS
% =================================================
N_or    = 9;       % Number of orientations (match paper K)
...
fprintf('\n========================================\n');
fprintf(' GLS LATENCY BENCHMARK (K=%d) — SERIAL\n', N_or);
fprintf('========================================\n');
...
save_path = fullfile(results_dir, sprintf('bench_GLS_K%d_serial.mat', N_or));
