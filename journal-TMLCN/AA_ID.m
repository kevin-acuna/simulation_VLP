...
data = readtable('database3D/data_20251218_113051.csv');
% data_20251028_121959 | robot :  pos8
    ...
    for s = 1:length(unique_samples)
        ...
        if height(muestras) > 0
            ...
            plot(x_vals, muestras.medida_daq, '-', 'Color', colorsMATLAB(mod(s-1,7)+1,:), ...
                 'MarkerSize', 4, 'DisplayName', sprintf('ID:%s (%.2f,%.2f,%.2f)', ...
...
set(h,'Position',[100 100 800 400]);  % [x y ancho alto]
set(gcf, 'Color', 'white');
