...
Simulations show an RMS error of 1.74\,cm with $K{=}9$ orientations and illustrate simultaneous 3D localization of three heterogeneous receivers from a single LED scan.
\end{abstract}
...
The GLS estimator exhibits a larger gap: RMSE of 3.98\,cm ($K=5$) and 2.46\,cm ($K=9$), corresponding to factors of 1.60$\times$ and 1.43$\times$ above the bound, respectively.
...
WLS, a diagonal simplification of GLS, further degrades to 4.87\,cm ($K=5$) and 3.60\,cm ($K=9$).
...
The estimated positions (star markers) closely overlap the ground-truth waypoints (open markers) across all three heights and trajectory types, with an APE of approximately 1\,cm.
