...
orientations_experiment_GLOBECOM_2026=[0.0,0.0, 34.0,182.0, 37.0,267.0, 37.0,355.0, 42.0,78.0, 53.0,97.0, 57.0,179.0, 58.0,360.0, 58.0,272.0];

orientation_PEB_K5_FINAL = [0,0, 60, 90 , 60, 180, 60, 270, 60,360];
orientation_PEB_K9_FINAL = [16,90, 16,210, 16,330, 60,0, 64,60, 64,120, 60,180, 64,240, 64,300];
% ==============================
